...
export const mockItems: Item[] = [
  {
    ...
    sellerUniversity: 'Warsaw University',
    sellerLanguages: ['English', 'Polish'],
  ...
  },
  {
    ...
    sellerUniversity: 'Krakow Tech',
    sellerLanguages: ['English', 'Chinese'],
